...
_import_structure = {
    ...
    "models.mmt5": ["T5_PRETRAINED_CONFIG_ARCHIVE_MAP", "MMT5Config"],
...
if is_sentencepiece_available():
    ...
    _import_structure["models.mmt5"].append("MMT5Tokenizer")
...
if is_tokenizers_available():
    ...
    _import_structure["models.mmt5"].append("MMT5TokenizerFast")
...
if is_torch_available():
    ...
    _import_structure["models.mmt5"].extend(["T5EncoderModel", "MMT5ForConditionalGeneration", "T5Model"])
...
if TYPE_CHECKING:
    ...
    from .models.mmt5 import MMT5Config
    ...
    if is_sentencepiece_available():
        ...
        from .models.mmt5 import MMT5TokenizerFast
    ...
    if is_torch_available():
        ...
        from .models.mmt5 import MMT5ForConditionalGeneration
