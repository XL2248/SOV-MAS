...
def get_transformer_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, last_epoch=-1):
...
TYPE_TO_SCHEDULER_FUNCTION = {
    ...
    SchedulerType.TRANSFORMER: get_transformer_schedule_with_warmup
}
