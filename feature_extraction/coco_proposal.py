...
#    parser.add_argument('--cocoroot', type=str, default='/ssd-playpen/home/jmincho/workspace/datasets/COCO/')
    parser.add_argument('--cocoroot', type=str, default='/apdcephfs/share_47076/chulunzhou/MMPretrain/downstream_data')
    parser.add_argument('--split', type=str, default='valid', choices=['train', 'valid', 'test2'])
    ...
    SPLIT2DIR = {
        ...
        'valid': 'val2014',
        'test': 'test2015',
        'test2': 'xFlick30k_coco',
    }

    coco_dir = Path(args.cocoroot).resolve()
#    coco_img_dir = coco_dir.joinpath('images')
    coco_img_split_dir = coco_dir.joinpath(SPLIT2DIR[args.split])
